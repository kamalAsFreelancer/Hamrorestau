...
<div class="sidebar" id="sidebar">
  <h2><i class="fas fa-utensils"></i> <span>Staff Panel</span></h2>
  <ul>
    <li><a href="dashboard.php"><i class="fas fa-chart-line"></i> <span>Take Order</span></a></li>
    ...
    <li><a href="staff.php"><i class="fas fa-user-friends"></i> <span>Manage Tables</span></a></li>    <li><a href="../includes/logout.php"><i class="fas fa-sign-out-alt"></i> <span>Logout</span></a></li>
  </ul>
